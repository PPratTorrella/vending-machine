...
class UserMoneyManagerTest extends TestCase
{
    ...
    public function testInsertCoin()
    {
        ...
        $moneyManager->insertCoin(25);
        $this->assertEquals([25], $moneyManager->getInsertedCoins());
        $moneyManager->insertCoin(10);
        $this->assertEquals([25, 10], $moneyManager->getInsertedCoins());
    }
    ...
    public function testGetTotal()
    {
        ...
        $moneyManager->insertCoin(25);
        $moneyManager->insertCoin(10);
        $this->assertEquals(35, $moneyManager->getTotal());
    }
    ...
    public function testReturnCoins()
    {
        ...
        $this->assertEquals([25, 10], $returnedCoins);
